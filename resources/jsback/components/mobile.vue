<template>    
    <div>
        ...
        v-show="!$parent.mostrarThumb" >Trocar imagem Mobile</button>
        <div class="mostrar" v-show="$parent.mostrarThumb">        
            ...
            <div class="row justify-content-center">
                ...
                <div class="col-md-12">
                    ...
                    Computadores</button>
                    <div class="compudator_mobile" v-show="$parent.lcomputadorThumb">
                ...
                reader.addEventListener("load", function () {                 
                    ...
                    image.onload = function (resultado) {                        
                        ...
                        if (height > self.opt.height || width > self.opt.width){                            
                            // self.$toastr.e(`${file.name} - Tamanho: ${this.width} x ${this.height} | mobile Largura ou altura inválida.`);
