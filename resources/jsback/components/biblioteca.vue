<template>    
    <div class="w100">
        <div class="area-biblioteca">

            <div class="header-content">                        
                <h3 class="header-title">Fotos do nossa Biblioteca</h3>
                        ...
                        <li v-for="(image, index) in images" :key="index">
                            <div class="item">
                                ...
                                class="background-box" 
                                    ...
                                    @click.stop.prevent="confirmarCapa('/storage/images/' + image.url)"
                                ...
                                <span 
                                    ...
                                    @click.stop.prevent="confirmarCapa('/storage/' + image.url)"
    ...
    export default {     
        ...
        methods:{
            ...
            sair(){
                ...
                var capa = this.$parent;
                if(this.editor)
                    this.editor.lbiblioteca=false;
                else
                    capa.$parent.lbiblioteca = false;
            ...
            search(){
                ...
                if(query) {
                    if (pagina>1)
                        url = `/api/lista/listar_midias/${query}?page=${pagina}`;
                    else
                        url = `/api/lista/listar_midias/${query}`;                      
                }
                else {
                     if (pagina>1)
                        url = `/api/lista/listar_midias/null?page=${pagina}`;                    
                    else
                        url = `/api/lista/listar_midias/null`;                      
                } 
                ...
                reader.addEventListener("load", function () {                 
                    ...
                    image.onload = function (resultado) {                        
                        ...
                        if (height > self.opt.height || width > self.opt.width){                            
                            self.$toastr.e(`${file.name} - Tamanho: ${this.width} x ${this.height} | Largura ou altura inválida.`);
